...
description: "Enhancing scenario understanding ablility for RL agent using LLM while suppressing the hallucinatory problems. (Dec 2024 - June 2025)"
...
1. [<u>HCRMP: A LLM-Hinted Contextual Reinforcement Learning Framework for Autonomous Driving</u>](https://zhuorenli.github.io/assets/pdf/paper/2025NIPS.pdf), Zhiwen Chen, Hanming Deng, **Zhuoren Li\***, Huanxi Wen,  Guizhe Jin, Ran Yu and Bo Leng\*, *Adv. Neural Inf. Process. Syst.*, 38, 105961-105998, 2025.
